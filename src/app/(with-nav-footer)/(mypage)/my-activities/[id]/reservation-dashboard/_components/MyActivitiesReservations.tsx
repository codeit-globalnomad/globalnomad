...
export default function MyActivitiesReservations({ selectedDate, setSelectedDate, activityId }: Props) {
  ...
  return (
    <div
      ref={dateRef}
      className='text-black-100 absolute top-[220px] right-0 flex h-[697px] min-h-[582px] w-[429px] flex-col gap-[27px] overflow-hidden rounded-[24px] border border-gray-300 bg-white px-6 py-6 shadow-md'
    >
